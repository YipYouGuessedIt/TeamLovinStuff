...
include('panel.php'); ?>
		...
		<div data-role="header" style="overflow:hidden;" id="headerP">
			...
			<a href="#myPanel" class="ui-btn-left ui-btn ui-btn-inline ui-mini ui-corner-all ui-btn-icon-left ui-icon-grid" >Menu</a>
			<a href="" id=<?php echo "'".$row["ID"]."'" ?> class="ui-btn-right ui-btn ui-btn-inline ui-mini ui-corner-all ui-btn-icon-right ui-icon-heart" name="moop" ></a>
		</div>
